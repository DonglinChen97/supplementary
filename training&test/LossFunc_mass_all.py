...
class MyLoss(nn.Module):
    ...
    def forward(self, pred, trut):
        ...
        lossMom = du2dx  +duvdy  -(dudx2 +dudy2) *iRe + dvudx  +dv2dy   -(dvdx2 +dvdy2) *iRe
        lossMom1 = du_2dx +du_v_dy-(du_dx2+du_dy2)*iRe + dv_u_dx+dv_2dy -(dv_dx2+dv_dy2)*iRe

        

        return lossMass,lossMass1, lossMom, lossMom1
